...
我相信，很久以后，Facebook 会自动学习我倾向于点开什么样的通知、忽略什么样的通知。 这些数据将使服务能够根据我对自己喜好的了解，自动向我发送个性化的通知。例如，如果它的算法注意到我总是忽略或忽略关于在新城市的通知，Facebook 可能会学会简单地停止向我显示该信息，或者向我显示其他信息。
...
我们提供导师指导的短期课程，如 Design 101，以及沉浸式的 UX Academy 课程，为你成为专业用户体验设计师的职业而做准备。[访问我们的课程网页以了解更多](http://trydesignlab.com/courses/)，如果有任何问题，请给我们留言我们 hello@trydesignlab.com。我们的下一课程从 8 月初开始，所以不要犹豫！
