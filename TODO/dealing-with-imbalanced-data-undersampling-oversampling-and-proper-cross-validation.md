...
在这里我们使用**回召率**，**真假率** 和 **AUC** 作为评测指标，关于指标的含义可以查看 [wikipedia](https://en.wikipedia.org/wiki/Sensitivity_and_specificity)
...
如之前所说，更多的数据并没有解决任何的问题，对于使用“智能”的过采样。它带来了非常高的精确度，但那是过拟合。下面是一些关于回召率和真假率指标的结果的分析和总结可以看看。
