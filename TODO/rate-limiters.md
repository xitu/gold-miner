...
- **向用户明确显示异常。**确定要现实给用户的异常类型。在实际操作中，你应该决定你想用[HTTP 429](https://tools.ietf.org/html/rfc6585#section-4) (Too Many Requests) 还是 [HTTP 503](https://tools.ietf.org/html/rfc7231#section-6.6.4) (Service Unavailable)，哪个是最准确的取决于根据情况的不同。你返回的信息也应该是可操作的。
