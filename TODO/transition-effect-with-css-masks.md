...
一份关于如何使用 CSS 遮罩来创建一些有趣的视觉滑动过渡的教程。高度可行！
...
这是一张为了达到有机外观揭露效果生成的雪碧图。我们将创建另一个『翻转的』雪碧图，用来达到相反的效果。你可以在 _img_  这个存放演示文件的文件夹下找到所有不同的雪碧图。
...
现在我们已经走到这儿啦，我们有了一个结构化、风格化的幻灯片。让我们将它变成功能化的！
