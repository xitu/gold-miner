...
上周，一个我最喜欢的应用发调查邮件给我。何乐而不为呢？但是我几乎无法完成调查，因为它太麻烦了。在一个主题下面同一页他们提问了2到3个问题，这导致我要上下左右移动我的屏幕才能看见完整问题。
...
*   **问题总数保持在8个以内** — 大多数专家建议保持调查内容简洁。我认为，8个问题将是最理想的状态，这将更好的优化问题，使他们更有价值，
