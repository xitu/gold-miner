...
我们将首先编写代码，然后部署协议并将 ABI 和 Address 插入到应用程序中。为了创建我们期待已久的赌场组件，它执行以下操作：
...
现在是我们在 store 中 action 和变体。首先导入 _getContract.js_ 文件，我相信您现在已经知道如何做到这一点了。然后在我们创造的过程中，调用它：
