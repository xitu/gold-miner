...
### **8) 我们将拥有四个统治元币，五十到一百个小硬币，以及这些硬币的无限虚拟变体，以及法币**
...
在区块链应用上构建一个首尾相连？朋友，你需要币！

![](https://cdn-images-1.medium.com/max/600/1*s70767X_wJBDhrgFEqf8ug.jpeg)

实际上，你不需要一个币。

硬币将开始摇摆到各种元类别。 在这一点上，我只能看到需要四种类型的硬币，区块链（或区块链技术）可以根据需要无缝地交换它们以消耗服务：
...
通货紧缩的硬币用于囤积和投资。随着时间的推移，它们将会增加并为储户带来收益。每个人都需要这种投资，这也是比特币首先起步的原因。

今天通货膨胀的币反映了美元。 没有人喜欢在股市上花费比特币，仅仅意识到他们几年后支付了 175,000 美元，因为比特币的价格上涨。我们需要稳定的，可用的货币。 想象一下，作为经典的“价值储藏”，保罗克鲁格曼总是唠唠叨叨，知道我们实际上确实需要这样来购买和出售每一天的商品。
...
**我们所有的经济学理论都是基于墨水和木浆时代的有限数据进行的研究。**所有当前的经济理论将被证明与洞穴绘画一样先进，因为我们在未来几年试验新的经济体系。

**这就是这些新币：战争时的微观经济体系。**

**这是达尔文的经济学。**

一些基本的经济规律将会成立，但其中许多基本规律将会走到尽头。 这是因为在区块链支配系统中，我们将在全球范围内获得实时经济数据，而不仅仅是一百年前用铅笔和纸张进行的一系列猜测。
...
DAO 需要人工智能来帮助管理和减轻其规则集，它需要能够自动生成模板**管理模型**。**在 DAO，管理是一切**，但作为一个开源的职场精英，今天管理一个有一定规模的大公司，没有很好的可扩展模型。早期 DAO 失败是因为他们拥有我所谓的[**勇敢新世界**](http://amzn.to/2gng6fk)问题。
...
设想一个软件项目，需要大量的代码，比如 10 万亿行代码。 软件项目只会变得越来越复杂，并且会持续增长。AI 会写和测试它的一半，但人们会写另一半。该项目将融入分布式，分散系统，大量分析工作，像项目经理一样工作，并根据声誉和技能组指纹将工作交付到遍布全球的网络中的编码人员。

想象它像一个 AI Github 嫁给了 UpWork 和 Mechanical Turk 系统。
...
在房地产的邪恶一面，我们有[**中国社会信用体系**](http://www.businessinsider.com/china-social-credit-score-like-black-mirror-2016-10)就像今天的 **_Black Mirror_** 一样。随着民族国家利用声望银行将意识形态压低人们的言论，它将变得更加糟糕。

但公开管理的代表银行将帮助我们找到关系并开展工作，并找出谁在商业和生活中信任谁。

它将是双刃剑。

主要的挑战是很少有人能够就系统中的好或坏达成一致，意识形态倾向于将这些概念变为无法识别的混乱。如果我们不小心的话，创建一个可以控制我们所有人的规则集非常容易。
...
**加密爱好者将不得不接受这样的事实，即区块链可以并将尽可能多的邪恶，因为它很好。**
...
如果你有一个系统现在的“快速行动，打破东西” DevOps 方法设计，只知道它是最有可能的系统，算法支配我们生活的许多方面的灾难。
...
我中途改了一篇名为 “ **如果希特勒拥有区块链** ？” 的文章。坦率地说，我不想发布它，因为我不想给坏人们任何新鲜的想法，但放心吧，可能无所谓。他们的黑暗头脑已经很难想象如何使用区块链作为压制和控制系统。
