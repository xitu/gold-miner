...
尽管基本不再使用物理活字了，现行的数字字体还是一样的用法。每个字母仍束缚在不可见的框内，有时这些框给字母对儿引入了过多的空白，要想有看上去均匀的空白就需要框与框有重叠。在过去的打印流程中，排字工人可以在木活字上刻 V 形切口让字母与字母靠得更近，看上去更舒服。而如今，工序不再繁琐，点几下鼠标就可以搞定。
