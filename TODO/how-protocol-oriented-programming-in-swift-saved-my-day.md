...
现在我将和你展示面向协议编程如何点亮我的人生的，我的应用是标准的左侧菜单导航带有一些选项的模式。这个应用大概有十个不同的 view controller，它们都是继承自一个拥有基础函数和各个界面需要的样式的基类 view controller。
...
面向协议编程是真正地点亮我的人生，现在每当我需要使用继承或者其他面向对象的原理来构建我的代码的时候，我会想它能否通过使用面向协议编程来更好的完成。我不是说它是完美的解决方案但是它仍然值得一试。
