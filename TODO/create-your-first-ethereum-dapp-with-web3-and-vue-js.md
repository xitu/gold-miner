...
我们的应用将会很简单。用户可以在 1 到 10 之间下注。当用户猜对时，他得到了他的奖励 x10（略低于庄家切牌）。
...
2. 我们需要知道合约的所有者并拥有访问权限（为简单起见，我们将不再修改所有者）
3. 合约的所有者可以销毁合约并提取余额
4. 用户可以在 1 - 10 之间下注
5. 在合约创建时，所有者能够设置最低下注金额和庄家上风（为简单起见，创建后不可更改）
...
**检出** [**PART 2**](https://medium.com/@Alt_Street/create-your-first-ethereum-dapp-with-web3-and-vue-js-part-2-52248a74d58a) **!**
