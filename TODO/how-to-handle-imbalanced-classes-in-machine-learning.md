...
假如你的客户是一家先进研究医院，他们要求你基于采集于病人的生物输入来训练一个用于检测一种疾病的模型。
...
这个数据集最初被生成用于模拟心理实验结果，但是对于我们非常有用，因为它大小可控并且包含不平衡类别
...
**注意：**如果你得到一个 0.47 的 AUROC，这仅仅意味着你需要翻转预测，因为 Scikit-Learn 误解释了正向类别。 AUROC 应该 >= 0.5。
...
嗯，树集合已经非常受欢迎，因为他们在许多现实世界的问题上表现的非常良好。我们当然一心的推荐他们。
