...
这有助于产品和商业转化率。在何种情况避免使用：不要在用户可能感到沮丧的情况下使用幽默。
...
我们往往认为积极的人格和价值描述是准确的，我们认为这些描述是“专为我们而写”的，然而这些描述往往含糊不清且适用于任何人。
...
1. 如果你认为 60% 的下载量会转化为真实用户 —— 假设真实用户只有你计算结果的 50%。
2. 如果你认为获得一个新用户将花费你 4 美元，那么就把它四舍五入到 5 美元。
3. 如果你的业务在艰难过冬 —— 为更漫长的寒冬做好准备。
