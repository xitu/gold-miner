...
无论何时和开发朋友们谈起关于自由工作的话题，我们总是在讨论一些担心的地方：

*   作为一个自有开发者，我怎样才能获得更多的客户？
...
我几年之前开始做一个自由工作者，我在想获取更多的客户时烦了很多错。

我开始认为这就像一块披萨。收费低（割小一点的披萨），会获得更多的项目（更多块披萨）。对吧？

![](https://cdn-images-1.medium.com/max/800/1*Yjyurn2b2xh2zISUFwRUPQ.jpeg)

我当初也认为我需要很明显的跟别人说我是一个自由工作者然后把这些信息发到社交媒体，不然的话，他们怎么能找到我？

在我最终认识到一些东西之前我一直犯着这些错误。

#### 收费低会给客户一种廉价的印象

这也导致他们会要求我在相同的价钱下做更多的工作。我也认识到，如果你直接的自我推荐会迅速让你丢失价值。
...
如果不是完全相符，最好的改变你形象的方式是创建一个个人网页来展示你是谁和你擅长什么。在你的网页加载好的前两秒钟内，解释你是做什么的。

> “让它令人印象深刻。让它令人有兴趣看下去。让它读起来有趣” —— Gary Vaynerchuk

这会刺激你的来访者在网页上滑下去，在这里你会给他们证明你有你所说的经验。稍后会讲更多关于这方面的东西。
...
当你专注于有质量时，你需要进行一些你专业相关领域的工作。比如，如果你是一个前端开发者，你肯定需要知道用户体验和表现相关的基础。这会帮助你交付出杰出的结果。
...
你怎么知道这是不是合法？你可以看到背景视频，我在不同场合（研习班，大会）进行演讲。通过这，访问者迅速会舍弃任何猜疑并且信服我确实是一个技术大会的演讲者。
...
当你考虑如何获得更多的客户时，许多人可能会想：好的，不如我开始在社交媒体上发动态说我在自由工作的活？
...
人们经常会问我，你是怎么学习 XYZ.. 的，二答案永远是一样的：我为它做了一个示例 app。
...
这些这是我免费的电子邮件课程[变成一个专家级开发者](https://learn.jadjoubran.io/)的一小部分意见。如果你喜欢这些意见，那你绝对会喜欢我的课程，因为我们会在如果增长你的专业性上讲得更深入，获取更多的有质量的客户，还有更多其他的东西。
