...
> “这个国家的每一个人都应该学习电脑编程，因为它教会你如何去思考。” —— 史蒂夫·乔布斯
...
为了找到正确的框架，我遵循了蒂姆·费里斯 (Tim Ferriss) 关于学习的书[《4小时厨师》 (the 4-Hour Chef)](https://www.amazon.com/dp/0547884591/?tag=richardreeze-20) 中的建议。
...
我问了他们相似的问题，你猜猜结果如何？他们的答案基本是一致的！
...
如何才能知道你什么时候才真正理解一个问题呢？答案是当你能够用简单的语言去描述的时候。
...
作为替代解决方案，你要把大问题解构为子问题。这些子问题要比大问题更加容易去解决。
...
> 例如，如果你是一个新程序员，然后你被要求去写一个程序，读取 10 个数字，然后算出那个数字是第三大的。对于一个权限的程序员来说，这可能是一项艰巨的任务，尽管它只需要基本的编程语法。

> 如果你陷入困境，你应该把问题简化。先不考虑找第三大的数，如果你去找最大的数你该如何做？还是太困难？那如果要从三个数字中找到最大的你该怎么做呢？如果从两个数字中寻找呢？

> 把问题简化到你知道如何解决并写出解决方案的程度。然后稍微把这个问题进行扩展，然后又编写解决方案去匹配它，然后继续下去，直到回到你解决问题开始的地方。” —— [V. Anton Spraul](http://vantonspraul.com/)
...
不同之处在于，最好的程序员/问题解决者遇到这种情况时对程序 bug 和错误的好奇心会比对问题的烦恼更多。
...
*   重新评估： 后退一步。从另外一个角度来看待这个问题。是否有可以抽象成更一般的方法？

> “有时候，我们对问题的细节太过沉迷，以至于忽略了在更一般的层面上解决问题的一般原则。 […]

> 当然，最经典的例子就是一长串连续整数和问题， 1 + 2 + 3 + … + n,对于这个问题，非常年轻的告诉很快就认识到了它就是简单的 n(n+1)/2,这样就不用去做加法了。” —— [C. Jordan Ball](https://www.linkedin.com/in/cjordanball/)

作者注：另外一种重新评估的方式是重新开始。删除所有内容，用全新的眼光重新开始。我是认真的，你会惊讶于这是多么的有效。

*   调查：啊哈，你没有读错，好好去搜索一下。无论你遇到什么样的问题，很可能已经有人解决过了。去找到那个人或者找到那种解决方法。事实上，即使你解决了问题，你也可以再去调查一下！（你可以从其他人的解决方案中学到很多的东西。）

注意：不要去寻找解决一个大问题的方法。只去寻找解决子问题的方案。这事为什么呢？因为除非你努力（哪怕是一点点），否则你什么都学不到。如果你什么都没有学到，你就是在浪费时间。
...
> “拜伦•里夫斯 (Byron Reeves) 说，‘如果你想看看三到五年后的商业领导力会是什么样子，那就看看网络游戏正在发生什么吧。’
...
所以，你应该做的是找到一个练习的出口。可以让你解决很多小问题的东西（理想情况下，这应该是你喜欢的东西）。
