...
*   Drepper的新网络接口(Linux 2.6+ 提案)   
    ...
    在OLS 2006上，Ulrich Drepper 提出了一种新的高速异步网络API。看到：
...
* 	[FreeBSD](http://people.freebsd.org/~julian/) 和 [NetBSD](http://web.mit.edu/nathanw/www/usenix/freenix-sa/)似乎仍然相信 M:N 线程...孤独的坚持?看起来像 freebsd 7.0 可能会切换到 1:1 线程(见上文)，所以也许 M:N 线程的信徒最终被证明是错误的。
