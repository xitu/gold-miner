...
- [优化构建](#build-optimizations)
   ...
   - [26.可以将 JavaScript 切换到 Web Worker 中吗？](#26-can-you-offload-javascript-into-a-web-worker)
   - [27.可以将 JavaScript 切换到 WebAssembly 中吗？](#27-can-you-offload-javascript-into-webassembly)
   - [28.是否使用了 AOT 编译？](#28-are-you-using-an-ahead-of-time-compiler)
   - [29.仅将遗留代码提供给旧版浏览器](#29-serve-legacy-code-only-to-legacy-browsers)
   - [30.是否使用了 JavaScript 差异化服务？](#30-are-you-using-differential-serving-for-javascript)
   - [31.通过增量解耦识别和重写遗留代码](#31-identify-and-rewrite-legacy-code-with-incremental-decoupling)
   - [32.识别并删除未使用的 CSS / JS](#32-identify-and-remove-unused-cssjs)
   - [33.减小 JavaScript 包的大小](#33-trim-the-size-of-your-javascript-bundles)
   - [34.是否使用了 JavaScript 代码块的预测预获取？](#34-are-you-using-predictive-prefetching-for-javascript-chunks)
   - [35.利用目标 JavaScript 引擎的优化](#35-take-advantage-of-optimizations-for-your-target-javascript-engine)
   - [36.使用客户端渲染还是服务器端渲染？](#36-client-side-rendering-or-server-side-rendering)
   - [37.约束第三方脚本的影响](#37-constrain-the-impact-of-third-party-scripts)
   - [38.设置 HTTP 缓存标头](#38-set-http-cache-headers-properl)
