...
1. 光线来自天空。（查看[部分 1](https://github.com/xitu/gold-miner/blob/master/TODO1/7-rules-for-creating-gorgeous-ui-part-1.md)
2. 首选白色和黑色（查看[部分 1](https://github.com/xitu/gold-miner/blob/master/TODO1/7-rules-for-creating-gorgeous-ui-part-1.md)
3. 添加更多的空白 （查看[部分 1](https://github.com/xitu/gold-miner/blob/master/TODO1/7-rules-for-creating-gorgeous-ui-part-1.md)
4. **学习如何在图片上添加文字**
5. **令文本层次分明**
6. **仅使用好看的字体** 
7. **像艺术家一样借鉴** 
...
**图片必须是黑色的**, 并且没有很多高对比度
**字体必须是白的** —— 我敢打赌你找不到一个又简单又干净的反例。 **真的**，只有白色这一个。
...
*   **边距** （讲道理这并不是一个字体本身**的**性质，但是可以用来吸引别人的注意，所以它可以出现在表上）
...
> 对于所有别的东西，你需要_**up-pop 并且 down-pop**_.
...
*  [Cosmin Capitanu](https://dribbble.com/Radium)。一个非常厉害的多面手。他做得东西未来感十足，但又不过于高调。他**非常**善于使用颜色，然而他并不十分注重UX的东西 —— 当然这个批评也针对 Dribbble 这个网站。
...
我写这篇文章是因为我希望自己在以前可以读到这篇。我希望这篇可以帮助你。如果你是个**UX 设计师**，在你素描出个大框架后做一个好看的 mockup。如果你是个**开发者**，接手下一个自己的项目然后让它变得很**好看**。我不希望需要去上几年艺术学校才能做好的UI。只要**观察**,**模仿**,并且**告诉你的朋友哪些可以用**。
