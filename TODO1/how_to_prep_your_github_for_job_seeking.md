...
不论是否合理，技术招聘方往往会从你的 GitHub 个人资料中推断出很多关于你的信息。而且现在越来越多的招聘者会要求你提供 GitHub 账号，或是能通过简单的 Google 搜索找到。因此，对于找工作的开发人员而言，有必要将 GitHub 看做简历的扩展。
...
首先，专业的成年人不会（在公开场合）发表这样的言论，所以请你一直秉持这个观念，不要像我曾经看到的一个例子一样，把这句话写在一个置顶仓库的 README.md 里。虽然我们公司现在没有使用任何微软的产品，但不会排除未来在技术或是财务上使用微软的某个产品。我们不需要一个不能以开放的态度来评估技术的开发者。
...
你一定需要清晰明确地解释如何运行（或者如果它是一个库，解释如何使用它）。
