...
*   [场景 1：我需要修改最近一次的提交](#场景-1：我需要修改最近一次的提交)
*   [场景 2：我需要修改一次特定的提交](#场景-2：我需要修改一次特定的提交)
*   [场景 3：我需要添加、移除或者合并提交](#场景-3：我需要添加、移除或者合并提交)
*   [场景 4：我的提交记录没啥有用的内容，我需要重新开始！](#场景-4：我的提交记录没啥有用的内容，我需要重新开始！)
