...
作为一名前端开发，你经常构建可视的东西，并且希望它们有好的视觉效果。同样的道理也体现在你的简历上。间隔合理，可读性强，透气。

#### 通过这篇文章你将学到的：

1. 针对软件开发人员的基本简历写作技巧。
2. 如何将 IT 技能和技术能力放在简历上。
...
在这一部分，你需要简洁的呈现信息。使用动作词汇来给招聘人员留下深刻印象，但要避免夸张。

#### 定制化

突出你所申请职位的相关信息，并保持简短。这将使你从那些写发往任何地方都一样的样板简历的人中脱颖而出。
...
ABC 公司是一家让世界变得更美好的公司，我们试图解决人类的问题。
...
* 平衡的需求，用户体验和截止日期，以便在有限的时间内获得大部分业务价值。
...
展示你过去的工作和项目可以快速证明你的 web 开发能力，在竞争激烈的市场中，可以增加获得面试的机会。你可以在 [CodePen](https://codepen.io/)或 [CakeResume](https://www.cakeresume.com)上面上传你的作品。

#### 描述一下你作品集中的工作

但是请记住，只提供一个你的应用程序的链接并不少建立作品集。只有一个线框或者你的应用程序的视觉效果而没有你的思路也是一个糟糕的想法。
