...
- [资源优化](#资源优化)
  - [17. 使用 Brotli 或 Zopfli 来对纯文本内容进行压缩](#17-使用-brotli-或-zopfli-来对纯文本内容进行压缩)
  - [18. 使用响应式图像和 WebP](#18-使用响应式图像和-webp)
  - [19. 图像是否已经被适当优化？](#19-图像是否已经被适当优化)
  - [20. 视频是否已经被适当优化?](#20-视频是否已经被适当优化)
  - [21. 网页字体是否已经优化？](#21-网页字体是否已经优化)
