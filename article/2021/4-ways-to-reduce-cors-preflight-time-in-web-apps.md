...
#### Tip: Share and reuse your data-fetching React hooks using Bit (Github).

[Bit](https://bit.dev) is often used to share React UI components across web projects but there’s absolutely no reason why you shouldn’t share your React hooks as well.

Build your highly optimized data-fetching hooks and share them with Bit to reuse across your applications.

![Example: a [React hook ](https://bit.dev/eden/jokes-app/hooks/use-get-jokes)shared on [Bit.dev](https://bit.dev)](https://cdn-images-1.medium.com/max/3582/1*MXKhhez8uRszG_8lohhNVg.png)
...
**Learn how to avoid CORS by using the proxy configuration in frontend development server.**blog.bitsrc.io](https://blog.bitsrc.io/how-and-why-you-should-avoid-cors-in-single-page-apps-db25452ad2f8)
