...
具对于拥有活跃的 V8 账号的开发者，可以使用 `git checkout -b 9.2 -t branch-heads/9.2` 来试验 V8 v9.2 的新功能。你也可以[订阅 Chrome 的 Beta 版频道](https://www.google.com/chrome/browser/beta.html) 以便尝试新功能。
