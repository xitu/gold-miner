...
**架构角色图**对 [BPMN模型](https://www.bpmn.org/) 进行了一些尝试。利用泳道来显示工作流中的不同角色。这种类型的图往往是较低级的，因为它比其他图包含更多的细节。一定要标明角色、工作流，以及关于业务流程如何从一个步骤到另一个步骤的所有假设。
...
> **P.S. 我总是使用 [draw.io](https://draw.io/) 来构建我的图表。它是一个免费的工具，提供了制作漂亮、全面的图表、模型和图的一切所需。**
