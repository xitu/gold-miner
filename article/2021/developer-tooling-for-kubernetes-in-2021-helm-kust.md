...
在过去的几年里，我们已经看到在 Kubernetes 生态中出现了大量工具用来实现更简单的软件开发（让我们面对现实，开箱即用是很难的）。正如经常发生在不断发展的生态系统中，一些工具不断发展并适应，而另一些工具则被抛弃，或者至少被合并到新的产品中。与对我们现有的选择进行最新审视相比，还有什么更好的方式来开启2021年呢？
