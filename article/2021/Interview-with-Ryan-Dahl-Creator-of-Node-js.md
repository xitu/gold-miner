...
**Ryan：** 正在进行中的很多事情：我们正在构建与 Hyper Web 服务器的绑定，它将提供 HTTP 2，并且可能比当前的 Web 服务器要快得多。我们正在构建 `deno lsp`，它提供了语言服务器协议，以便 VS Code（和其他 IDE）可以直接与 Deno 进行交流，以突出显示语法，进行类型检查，格式化等 —— 期望下一次的编辑体验会大大改善几个月。我们正在努力通过尽可能多的 Web 平台测试-因此，随着时间的推移，Deno 会变得与 Web 更加兼容。请查看 Q1 路线图，以了解更多详细信息。
