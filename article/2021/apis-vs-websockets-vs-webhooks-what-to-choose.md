...
![Example: exploring reusable React components shared on [Bit.dev](https://bit.dev/)](https://cdn-images-1.medium.com/max/3678/0*MeJEFYRSlF6wNtKr.gif)
...
**Connect your toolchain and get notified on component events- to trigger anything!**blog.bitsrc.io](https://blog.bitsrc.io/introducing-bit-dev-webhooks-78dade77c6da)
[**Mock APIs: Different Techniques for React and Angular**
**Different techniques you can use for API Mocking when developing Angular and React frontend features**blog.bitsrc.io](https://blog.bitsrc.io/mock-apis-different-techniques-for-react-and-angular-156284b757f4)
[**Building REST API in Nodejs / MongoDB /Passport /JWT**
**In this lesson, we will start our journey on making REST APIs with NodeJSalong with MongoDB database. if you don’t have…**kris101.medium.com](https://kris101.medium.com/building-rest-api-in-nodejs-mongodb-passport-jwt-6c557332d4ca)
