...
![An independently source-controlled and shared “card” component. On the right => its dependency graph, auto-generated by Bit.](https://cdn-images-1.medium.com/max/3546/1*zGUo5gijshzi_iKEgxg1Ow.png)
...
**Introducing WebTransport, the successor for WebRTC for real-time web communication**blog.bitsrc.io](https://blog.bitsrc.io/will-webtransport-replace-webrtc-in-near-future-436c4f7f3484)
[**Will Bit Replace npm?**
**What role do Bit and Bit.dev play in web development?**blog.bitsrc.io](https://blog.bitsrc.io/will-bit-replace-npm-44a866a067da)
[**Build an Image Sharing App with WebRTC and PeerJS**
**A straight-forward tutorial with examples.**blog.bitsrc.io](https://blog.bitsrc.io/use-webrtc-and-peerjs-to-build-an-image-sharing-app-f8163b6a6266)
