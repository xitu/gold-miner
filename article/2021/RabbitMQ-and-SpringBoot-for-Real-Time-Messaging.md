...
[**GitHub - iamtanbirahmed/real-time-comm: A real-time communication application using RabbitMQ and…**
*A real-time communication application using RabbitMQ and SpringBoot You don't have to run the docker if you already…*github.com](https://github.com/iamtanbirahmed/real-time-comm)
