...
[Istio](https://istio.io/) 是一个开放的框架，用于整合微服务、通过微服务监控流量移动、实施政策以及以标准化方式聚合遥测数据。Istio的控制平面在集群管理（如 Kubernetes）的底层平台上提供了一个抽象层。
...
- 通过强大的基于身份的身份验证和授权，在集群集中进行安全的服务间通信。

![[Image Source](https://istio.io/)](https://uploads-ssl.webflow.com/5c9200c49b1194323aff7304/5fae5c3ad3b5421ccfa359f7_3.jpg)

## 5. Checkov

[Checkov](https://www.checkov.io/) 是一个基础架构即代码的静态检查工具。它扫描 Terraform，云详细信息，Cubanet，无服务器或 ARM 模型云基础架构，并检测安全性和合规性配置错误。
...
[Prometheus](https://github.com/prometheus/prometheus) 是 Cloud Native Computing Foundation 项目，是一个系统和服务监视系统。它在特定时间从已配置的目标中提取指标，测试规则并显示结果。如果违反了指定条件，它将触发通知。
