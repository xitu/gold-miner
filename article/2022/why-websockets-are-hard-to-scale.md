...
> _无耻的自我推销：_我认为 websockets 是 web 网页的一个重要部分并且它们需要在软件开发界得到更多的认可。我正在计划发布更多的有关于 websockets 的文章。如果你不想错过这些文章，你可以访问 [https://nooptoday.com/](https://nooptoday.com/) 并且订阅我的邮箱列表！
