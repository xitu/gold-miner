...
编程很像写作 —— 你应该从“[不完美的初稿](https://medium.com/@jeffgoins/dont-waste-your-words-how-to-write-a-first-draft-that-is-crappy-but-usable-c5dbf977f5a5)”开始，然后开始挨个地解决初稿中存在的问题，并对每个问题进行两到三遍修改和编辑。工程师们肯定会嘲笑自己居然被轻率地比作了”作家“—— 但是今天早上的文档又是谁写的呢？你不是在“写代码”吗?
...
让我来向你推荐“不完美的初稿” —— 因为这可以让你成为效率更高的 “coder”。

## ”不完美初稿”的诀窍

“不完美初稿”的诀窍非常普遍，以至于你可能在英语课堂上就此事听说过，即使你没有在网上看过有关解决写作困境的相关博客。
...
另外，简单的代码易于编写，从而节省了时间。的确，它可能会存在重复的代码，但是你的大脑妙处就在于它会要求你去使用更少的代码并具有高性能的“更好”的解决方案。

**忽略他**

诀窍是在有这些感觉时先喝点饮料，然后在追求简单的道路中勇往直前。等到代码生效后，你将立即对其进行重构 —— 在拥有能够正常工作的版本之后，你就可以让自己想法变得更加复杂。但是在这之前，请尽可能的让事情简单。
...
但是，这里的编程和写作有所不同：因为代码必须可以成功执行，所以开发人员都知道什么时候第一稿算是“足够好”。当你的代码正常工作时，这就是立即编辑“简单的初稿”的信号，并在进行下一步之前对其进行多次的修改和完善。

对于任何只是学习编码的人，这个方法都会提高两项关键技能：编写有效的代码，并在不破坏现有代码的情况下对代码进行改进。
...
>
> 余：如果 `arrayOne` 中的元素与 `arrayTwo` 中大于 20 的元素相加时，还需要额外加上 1。
...
重构，喜欢还是不喜欢这段代码能在编辑修改的过程中能够更清楚的知道。在编程和其他类型的写作中，如果是你自己编写的文本（尤其是立即完成），修改会变得更加容易。
...
就个人而言，我发现专注于“不完美的初稿”（或我喜欢说的“简单初稿”）使我更有可能先写测试，因为我不并不在乎写的测试是否是完美的 。
